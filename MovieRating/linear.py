...
for train_num, train in enumerate(trains):
	...
	for num, tra in enumerate(train):
		...
		features[train_num][num + col] = float(tra) ** 2

theta = np.zeros(col * 2 - 1)
learning = 0.05
i = 0
while True:
